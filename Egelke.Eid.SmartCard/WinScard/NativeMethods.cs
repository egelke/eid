...
namespace Egelke.Eid.SmartCard.WinScard
{
    ...
    public static class NativeMethods
    {
        ...
        [DllImport("winscard.dll", CharSet = CharSet.Auto)]
        public static extern int SCardLocateCards(SafeCardContextHandle hContext, [In, MarshalAs(UnmanagedType.LPArray)] Char[] mszCards, [In, Out] SCARD_READERSTATE[] rgReaderStates, int cReaders);
